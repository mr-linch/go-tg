...
// GuestMessage handles new guest message.
// The bot can use the field Message.guest_query_id and the method [tg.Client.AnswerGuestQuery] to send a message in response.
func (bot *Router) GuestMessage(handler MessageHandler, filters ...Filter) *Router {
	return bot.register(tg.UpdateTypeGuestMessage, handler, filters...)
}
...
// ManagedBot handles a new bot was created to be managed by the bot, or token or owner of a managed bot was changed
...
// Subscription handles user payment subscription has changed
func (bot *Router) Subscription(handler SubscriptionHandler, filters ...Filter) *Router {
	return bot.register(tg.UpdateTypeSubscription, handler, filters...)
}

// StoppedMessageGeneration handles a user asked the bot to stop the generation of a message
func (bot *Router) StoppedMessageGeneration(handler StoppedMessageGenerationHandler, filters ...Filter) *Router {
	return bot.register(tg.UpdateTypeStoppedMessageGeneration, handler, filters...)
}
