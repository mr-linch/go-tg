...
// StoppedMessageGenerationHandler it's typed handler for [StoppedMessageGenerationUpdate].
// Implements [Handler] interface.
type StoppedMessageGenerationHandler func(context.Context, *StoppedMessageGenerationUpdate) error

func (handler StoppedMessageGenerationHandler) Handle(ctx context.Context, update *Update) error {
	return handler(ctx, &StoppedMessageGenerationUpdate{
		MessageGenerationStopped: update.StoppedMessageGeneration,
		BaseUpdate:               BaseUpdate{Update: update, Client: update.Client},
	})
}

// SubscriptionHandler it's typed handler for [SubscriptionUpdate].
// Implements [Handler] interface.
type SubscriptionHandler func(context.Context, *SubscriptionUpdate) error

func (handler SubscriptionHandler) Handle(ctx context.Context, update *Update) error {
	return handler(ctx, &SubscriptionUpdate{
		BotSubscriptionUpdated: update.Subscription,
		BaseUpdate:             BaseUpdate{Update: update, Client: update.Client},
	})
}
