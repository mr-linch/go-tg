...
// AnswerLivePhoto calls [tg.Client.SendLivePhoto].
func (msg *MessageUpdate) AnswerLivePhoto(livePhoto, photo tg.FileArg) *tg.SendLivePhotoCall {
	return msg.Client.SendLivePhoto(msg.Chat, livePhoto, photo)
}
...
// AnswerRichMessage calls [tg.Client.SendRichMessage].
func (msg *MessageUpdate) AnswerRichMessage(richMessage tg.InputRichMessage) *tg.SendRichMessageCall {
	return msg.Client.SendRichMessage(msg.Chat, richMessage)
}

// AnswerRichMessageDraft calls [tg.Client.SendRichMessageDraft].
func (msg *MessageUpdate) AnswerRichMessageDraft(draftID int, richMessage tg.InputRichMessage) *tg.SendRichMessageDraftCall {
	return msg.Client.SendRichMessageDraft(msg.Chat, draftID, richMessage)
}
...
// StoppedMessageGenerationUpdate it's extend wrapper around [tg.MessageGenerationStopped].
type StoppedMessageGenerationUpdate struct {
	*tg.MessageGenerationStopped
	BaseUpdate
}

// SubscriptionUpdate it's extend wrapper around [tg.BotSubscriptionUpdated].
type SubscriptionUpdate struct {
	*tg.BotSubscriptionUpdated
	BaseUpdate
}
