...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendMessageCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendMessageCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// Use this method to copy messages of any kind. Service messages, paid media messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz [Poll] can be copied only if the value of the field correct_option_ids is known to the bot. The method is analogous to the method [Client.ForwardMessage], but the copied message doesn't have a link to the original message. Returns the [MessageID] of the sent message on success.
//
...
// Use this method to copy messages of any kind. If some of the specified messages can't be found or copied, they are skipped. Service messages, paid media messages, giveaway messages, giveaway winners messages, and invoice messages can't be copied. A quiz [Poll] can be copied only if the value of the field correct_option_ids is known to the bot. The method is analogous to the method [Client.ForwardMessages], but the copied messages don't have a link to the original message. Album grouping is kept for copied messages. On success, an Array of [MessageID] of the sent messages is returned.
//
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendPhotoCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendPhotoCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// SendLivePhotoCall represents a call to the [sendLivePhoto] method.
// Use this method to send live photos. On success, the sent [Message] is returned.
//
// [sendLivePhoto]: https://core.telegram.org/bots/api#sendlivephoto
type SendLivePhotoCall struct {
	Call[Message]
}

// NewSendLivePhotoCall constructs a new [SendLivePhotoCall].
//
// Required params:
...
//
// [More information on Sending Files »]: https://core.telegram.org/bots/api#sending-files
func NewSendLivePhotoCall(chatID PeerID, livePhoto FileArg, photo FileArg) *SendLivePhotoCall {
	return &SendLivePhotoCall{
		Call[Message]{
			request: NewRequest("sendLivePhoto").
				PeerID("chat_id", chatID).
				File("live_photo", livePhoto).
				File("photo", photo),
		},
	}
}

// SendLivePhoto constructs a new [SendLivePhotoCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target channel (in the format @channelusername)
//   - livePhoto: Live photo video to send. The video must be no longer than 10 seconds and must not exceed 10 MB in size. Pass a file_id as String to send a video that exists on the Telegram servers (recommended) or upload a new video using multipart/form-data. [More information on Sending Files »]. Sending live photos by a URL is currently unsupported.
...
//
// [More information on Sending Files »]: https://core.telegram.org/bots/api#sending-files
func (client *Client) SendLivePhoto(chatID PeerID, livePhoto FileArg, photo FileArg) *SendLivePhotoCall {
	return BindClient(
		NewSendLivePhotoCall(chatID, livePhoto, photo),
		client,
	)
}

// BusinessConnectionID sets the business_connection_id parameter.
func (call *SendLivePhotoCall) BusinessConnectionID(businessConnectionID string) *SendLivePhotoCall {
	call.request.String("business_connection_id", businessConnectionID)
	return call
}

// ChatID sets the chat_id parameter.
func (call *SendLivePhotoCall) ChatID(chatID PeerID) *SendLivePhotoCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// MessageThreadID sets the message_thread_id parameter.
func (call *SendLivePhotoCall) MessageThreadID(messageThreadID int) *SendLivePhotoCall {
	call.request.Int("message_thread_id", messageThreadID)
	return call
}

// DirectMessagesTopicID sets the direct_messages_topic_id parameter.
func (call *SendLivePhotoCall) DirectMessagesTopicID(directMessagesTopicID int) *SendLivePhotoCall {
	call.request.Int("direct_messages_topic_id", directMessagesTopicID)
	return call
}

// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendLivePhotoCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendLivePhotoCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}

// LivePhoto sets the live_photo parameter.
func (call *SendLivePhotoCall) LivePhoto(livePhoto FileArg) *SendLivePhotoCall {
	call.request.File("live_photo", livePhoto)
	return call
}

// Photo sets the photo parameter.
func (call *SendLivePhotoCall) Photo(photo FileArg) *SendLivePhotoCall {
	call.request.File("photo", photo)
	return call
}

// Caption sets the caption parameter.
func (call *SendLivePhotoCall) Caption(caption string) *SendLivePhotoCall {
	call.request.String("caption", caption)
	return call
}

// ParseMode sets the parse_mode parameter.
func (call *SendLivePhotoCall) ParseMode(parseMode ParseMode) *SendLivePhotoCall {
	call.request.Stringer("parse_mode", parseMode)
	return call
}

// CaptionEntities sets the caption_entities parameter.
func (call *SendLivePhotoCall) CaptionEntities(captionEntities []MessageEntity) *SendLivePhotoCall {
	call.request.JSON("caption_entities", captionEntities)
	return call
}

// ShowCaptionAboveMedia sets the show_caption_above_media parameter.
func (call *SendLivePhotoCall) ShowCaptionAboveMedia(showCaptionAboveMedia bool) *SendLivePhotoCall {
	call.request.Bool("show_caption_above_media", showCaptionAboveMedia)
	return call
}

// HasSpoiler sets the has_spoiler parameter.
func (call *SendLivePhotoCall) HasSpoiler(hasSpoiler bool) *SendLivePhotoCall {
	call.request.Bool("has_spoiler", hasSpoiler)
	return call
}

// DisableNotification sets the disable_notification parameter.
func (call *SendLivePhotoCall) DisableNotification(disableNotification bool) *SendLivePhotoCall {
	call.request.Bool("disable_notification", disableNotification)
	return call
}

// ProtectContent sets the protect_content parameter.
func (call *SendLivePhotoCall) ProtectContent(protectContent bool) *SendLivePhotoCall {
	call.request.Bool("protect_content", protectContent)
	return call
}

// AllowPaidBroadcast sets the allow_paid_broadcast parameter.
func (call *SendLivePhotoCall) AllowPaidBroadcast(allowPaidBroadcast bool) *SendLivePhotoCall {
	call.request.Bool("allow_paid_broadcast", allowPaidBroadcast)
	return call
}

// MessageEffectID sets the message_effect_id parameter.
func (call *SendLivePhotoCall) MessageEffectID(messageEffectID string) *SendLivePhotoCall {
	call.request.String("message_effect_id", messageEffectID)
	return call
}

// SuggestedPostParameters sets the suggested_post_parameters parameter.
func (call *SendLivePhotoCall) SuggestedPostParameters(suggestedPostParameters SuggestedPostParameters) *SendLivePhotoCall {
	call.request.JSON("suggested_post_parameters", suggestedPostParameters)
	return call
}

// ReplyParameters sets the reply_parameters parameter.
func (call *SendLivePhotoCall) ReplyParameters(replyParameters ReplyParameters) *SendLivePhotoCall {
	call.request.JSON("reply_parameters", replyParameters)
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *SendLivePhotoCall) ReplyMarkup(replyMarkup ReplyMarkup) *SendLivePhotoCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendAudioCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendAudioCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendDocumentCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendDocumentCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendVideoCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendVideoCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendAnimationCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendAnimationCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendVoiceCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendVoiceCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendVideoNoteCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendVideoNoteCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendLocationCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendLocationCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendVenueCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendVenueCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendContactCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendContactCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// AllowsRevoting sets the allows_revoting parameter.
func (call *SendPollCall) AllowsRevoting(allowsRevoting bool) *SendPollCall {
	call.request.Bool("allows_revoting", allowsRevoting)
	return call
}

// ShuffleOptions sets the shuffle_options parameter.
func (call *SendPollCall) ShuffleOptions(shuffleOptions bool) *SendPollCall {
	call.request.Bool("shuffle_options", shuffleOptions)
	return call
}

// AllowAddingOptions sets the allow_adding_options parameter.
func (call *SendPollCall) AllowAddingOptions(allowAddingOptions bool) *SendPollCall {
	call.request.Bool("allow_adding_options", allowAddingOptions)
	return call
}

// HideResultsUntilCloses sets the hide_results_until_closes parameter.
func (call *SendPollCall) HideResultsUntilCloses(hideResultsUntilCloses bool) *SendPollCall {
	call.request.Bool("hide_results_until_closes", hideResultsUntilCloses)
	return call
}

// MembersOnly sets the members_only parameter.
func (call *SendPollCall) MembersOnly(membersOnly bool) *SendPollCall {
	call.request.Bool("members_only", membersOnly)
	return call
}

// CountryCodes sets the country_codes parameter.
func (call *SendPollCall) CountryCodes(countryCodes []string) *SendPollCall {
	call.request.JSON("country_codes", countryCodes)
	return call
}

// CorrectOptionIDs sets the correct_option_ids parameter.
func (call *SendPollCall) CorrectOptionIDs(correctOptionIDs []int) *SendPollCall {
	call.request.JSON("correct_option_ids", correctOptionIDs)
	return call
}
...
// ExplanationMedia sets the explanation_media parameter.
func (call *SendPollCall) ExplanationMedia(explanationMedia InputPollMediaClass) *SendPollCall {
	call.request.JSON("explanation_media", explanationMedia.AsInputPollMedia())
	return call
}
...
func (call *SendPollCall) Description(description string) *SendPollCall {
	call.request.String("description", description)
	return call
}

// DescriptionParseMode sets the description_parse_mode parameter.
func (call *SendPollCall) DescriptionParseMode(descriptionParseMode string) *SendPollCall {
	call.request.String("description_parse_mode", descriptionParseMode)
	return call
}

// DescriptionEntities sets the description_entities parameter.
func (call *SendPollCall) DescriptionEntities(descriptionEntities []MessageEntity) *SendPollCall {
	call.request.JSON("description_entities", descriptionEntities)
	return call
}

// Media sets the media parameter.
func (call *SendPollCall) Media(media InputPollMediaClass) *SendPollCall {
	call.request.JSON("media", media.AsInputPollMedia())
	return call
}
...
func NewSendChecklistCall(businessConnectionID string, chatID PeerID, checklist InputChecklist) *SendChecklistCall {
...
//   - chatID: Unique identifier for the target chat or username of the target bot in the format @username
//   - checklist: A JSON-serialized object for the checklist to send
func (client *Client) SendChecklist(businessConnectionID string, chatID PeerID, checklist InputChecklist) *SendChecklistCall {
	return BindClient(
...
// ChatID sets the chat_id parameter.
func (call *SendChecklistCall) ChatID(chatID PeerID) *SendChecklistCall {
	call.request.PeerID("chat_id", chatID)
	return call
}
...
// Use this method to stream a partial message to a user while the message is being generated. Note that the streamed draft is ephemeral and acts as a temporary 30-second preview - once the output is finalized, you must call [Client.SendMessage] with the complete message to persist it in the user's chat. Returns True on success.
//
...
func NewSendMessageDraftCall(chatID int, draftID int) *SendMessageDraftCall {
...
//   - chatID: Unique identifier for the target private chat
//   - draftID: Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. Otherwise, the draft is replaced without animation.
func (client *Client) SendMessageDraft(chatID int, draftID int) *SendMessageDraftCall {
	return BindClient(
		NewSendMessageDraftCall(chatID, draftID),
		client,
	)
}
...
// CanStop sets the can_stop parameter.
func (call *SendMessageDraftCall) CanStop(canStop bool) *SendMessageDraftCall {
	call.request.Bool("can_stop", canStop)
	return call
}

// KeepOnStop sets the keep_on_stop parameter.
func (call *SendMessageDraftCall) KeepOnStop(keepOnStop bool) *SendMessageDraftCall {
	call.request.Bool("keep_on_stop", keepOnStop)
	return call
}
...
// GetUserProfileAudiosCall represents a call to the [getUserProfileAudios] method.
...
func NewGetUserProfileAudiosCall(userID UserID) *GetUserProfileAudiosCall {
	return &GetUserProfileAudiosCall{
		Call[UserProfileAudios]{
			request: NewRequest("getUserProfileAudios").
				UserID("user_id", userID),
		},
	}
}
...
func (client *Client) GetUserProfileAudios(userID UserID) *GetUserProfileAudiosCall {
	return BindClient(
		NewGetUserProfileAudiosCall(userID),
		client,
	)
}

// UserID sets the user_id parameter.
func (call *GetUserProfileAudiosCall) UserID(userID UserID) *GetUserProfileAudiosCall {
	call.request.UserID("user_id", userID)
	return call
}

// Offset sets the offset parameter.
func (call *GetUserProfileAudiosCall) Offset(offset int) *GetUserProfileAudiosCall {
	call.request.Int("offset", offset)
	return call
}

// Limit sets the limit parameter.
func (call *GetUserProfileAudiosCall) Limit(limit int) *GetUserProfileAudiosCall {
	call.request.Int("limit", limit)
	return call
}
...
// CanManageTags sets the can_manage_tags parameter.
func (call *PromoteChatMemberCall) CanManageTags(canManageTags bool) *PromoteChatMemberCall {
	call.request.Bool("can_manage_tags", canManageTags)
	return call
}

// CanSendWelcomeMessages sets the can_send_welcome_messages parameter.
func (call *PromoteChatMemberCall) CanSendWelcomeMessages(canSendWelcomeMessages bool) *PromoteChatMemberCall {
	call.request.Bool("can_send_welcome_messages", canSendWelcomeMessages)
	return call
}
...
// SetChatMemberTagCall represents a call to the [setChatMemberTag] method.
// Use this method to set a tag for a regular member in a group or a supergroup. The bot must be an administrator in the chat for this to work and must have the can_manage_tags administrator right. Returns True on success.
//
// [setChatMemberTag]: https://core.telegram.org/bots/api#setchatmembertag
type SetChatMemberTagCall struct {
	CallNoResult
}

// NewSetChatMemberTagCall constructs a new [SetChatMemberTagCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - userID: Unique identifier of the target user
func NewSetChatMemberTagCall(chatID PeerID, userID UserID) *SetChatMemberTagCall {
	return &SetChatMemberTagCall{
		CallNoResult{
			request: NewRequest("setChatMemberTag").
				PeerID("chat_id", chatID).
				UserID("user_id", userID),
		},
	}
...
// SetChatMemberTag constructs a new [SetChatMemberTagCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - userID: Unique identifier of the target user
func (client *Client) SetChatMemberTag(chatID PeerID, userID UserID) *SetChatMemberTagCall {
	return BindClient(
		NewSetChatMemberTagCall(chatID, userID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *SetChatMemberTagCall) ChatID(chatID PeerID) *SetChatMemberTagCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// UserID sets the user_id parameter.
func (call *SetChatMemberTagCall) UserID(userID UserID) *SetChatMemberTagCall {
	call.request.UserID("user_id", userID)
	return call
}

// Tag sets the tag parameter.
func (call *SetChatMemberTagCall) Tag(tag string) *SetChatMemberTagCall {
	call.request.String("tag", tag)
	return call
}
...
// AnswerChatJoinRequestQueryCall represents a call to the [answerChatJoinRequestQuery] method.
// Use this method to process a received chat join request query. Returns True on success.
//
// [answerChatJoinRequestQuery]: https://core.telegram.org/bots/api#answerchatjoinrequestquery
type AnswerChatJoinRequestQueryCall struct {
	CallNoResult
}

// NewAnswerChatJoinRequestQueryCall constructs a new [AnswerChatJoinRequestQueryCall].
//
// Required params:
...
func NewAnswerChatJoinRequestQueryCall(chatJoinRequestQueryID string, result string) *AnswerChatJoinRequestQueryCall {
	return &AnswerChatJoinRequestQueryCall{
		CallNoResult{
			request: NewRequest("answerChatJoinRequestQuery").
				String("chat_join_request_query_id", chatJoinRequestQueryID).
				String("result", result),
		},
	}
}

// AnswerChatJoinRequestQuery constructs a new [AnswerChatJoinRequestQueryCall].
//
// Required params:
//   - chatJoinRequestQueryID: Unique identifier of the join request query
//   - result: Result of the query. Must be either “approve” to allow the user to join the chat, “decline” to disallow the user to join the chat, or “queue” to leave the decision to other administrators.
func (client *Client) AnswerChatJoinRequestQuery(chatJoinRequestQueryID string, result string) *AnswerChatJoinRequestQueryCall {
	return BindClient(
		NewAnswerChatJoinRequestQueryCall(chatJoinRequestQueryID, result),
		client,
	)
}

// ChatJoinRequestQueryID sets the chat_join_request_query_id parameter.
func (call *AnswerChatJoinRequestQueryCall) ChatJoinRequestQueryID(chatJoinRequestQueryID string) *AnswerChatJoinRequestQueryCall {
	call.request.String("chat_join_request_query_id", chatJoinRequestQueryID)
	return call
}

// Result sets the result parameter.
func (call *AnswerChatJoinRequestQueryCall) Result(result string) *AnswerChatJoinRequestQueryCall {
	call.request.String("result", result)
	return call
}

// SendChatJoinRequestWebAppCall represents a call to the [sendChatJoinRequestWebApp] method.
// Use this method to process a received chat join request query by showing a Mini App to the user before deciding the outcome. Call [Client.AnswerChatJoinRequestQuery] to resolve the join request query based on the user interaction with the Mini App. Returns True on success.
//
// [sendChatJoinRequestWebApp]: https://core.telegram.org/bots/api#sendchatjoinrequestwebapp
type SendChatJoinRequestWebAppCall struct {
	CallNoResult
}

// NewSendChatJoinRequestWebAppCall constructs a new [SendChatJoinRequestWebAppCall].
//
// Required params:
//   - chatJoinRequestQueryID: Unique identifier of the join request query
...
func NewSendChatJoinRequestWebAppCall(chatJoinRequestQueryID string, webAppURL string) *SendChatJoinRequestWebAppCall {
	return &SendChatJoinRequestWebAppCall{
		CallNoResult{
			request: NewRequest("sendChatJoinRequestWebApp").
				String("chat_join_request_query_id", chatJoinRequestQueryID).
				String("web_app_url", webAppURL),
		},
	}
}

// SendChatJoinRequestWebApp constructs a new [SendChatJoinRequestWebAppCall].
//
// Required params:
//   - chatJoinRequestQueryID: Unique identifier of the join request query
//   - webAppURL: An HTTPS URL of a Web App to be opened with additional data as specified in [Initializing Web Apps]
//
// [Initializing Web Apps]: https://core.telegram.org/bots/webapps#initializing-mini-apps
func (client *Client) SendChatJoinRequestWebApp(chatJoinRequestQueryID string, webAppURL string) *SendChatJoinRequestWebAppCall {
	return BindClient(
		NewSendChatJoinRequestWebAppCall(chatJoinRequestQueryID, webAppURL),
		client,
	)
}

// ChatJoinRequestQueryID sets the chat_join_request_query_id parameter.
func (call *SendChatJoinRequestWebAppCall) ChatJoinRequestQueryID(chatJoinRequestQueryID string) *SendChatJoinRequestWebAppCall {
	call.request.String("chat_join_request_query_id", chatJoinRequestQueryID)
	return call
}

// WebAppURL sets the web_app_url parameter.
func (call *SendChatJoinRequestWebAppCall) WebAppURL(webAppURL string) *SendChatJoinRequestWebAppCall {
	call.request.String("web_app_url", webAppURL)
	return call
}
...
// ReturnBots sets the return_bots parameter.
func (call *GetChatAdministratorsCall) ReturnBots(returnBots bool) *GetChatAdministratorsCall {
	call.request.Bool("return_bots", returnBots)
	return call
}
...
// GetUserPersonalChatMessagesCall represents a call to the [getUserPersonalChatMessages] method.
...
type GetUserPersonalChatMessagesCall struct {
	Call[[]Message]
}

// NewGetUserPersonalChatMessagesCall constructs a new [GetUserPersonalChatMessagesCall].
//
// Required params:
//   - userID: Unique identifier for the target user
//   - limit: The maximum number of messages to return; 1-20
func NewGetUserPersonalChatMessagesCall(userID UserID, limit int) *GetUserPersonalChatMessagesCall {
	return &GetUserPersonalChatMessagesCall{
		Call[[]Message]{
			request: NewRequest("getUserPersonalChatMessages").
				UserID("user_id", userID).
				Int("limit", limit),
		},
	}
...
// GetUserPersonalChatMessages constructs a new [GetUserPersonalChatMessagesCall].
//
// Required params:
//   - userID: Unique identifier for the target user
//   - limit: The maximum number of messages to return; 1-20
func (client *Client) GetUserPersonalChatMessages(userID UserID, limit int) *GetUserPersonalChatMessagesCall {
	return BindClient(
		NewGetUserPersonalChatMessagesCall(userID, limit),
		client,
	)
}

// UserID sets the user_id parameter.
func (call *GetUserPersonalChatMessagesCall) UserID(userID UserID) *GetUserPersonalChatMessagesCall {
	call.request.UserID("user_id", userID)
	return call
}

// Limit sets the limit parameter.
func (call *GetUserPersonalChatMessagesCall) Limit(limit int) *GetUserPersonalChatMessagesCall {
	call.request.Int("limit", limit)
	return call
}
...
// AnswerGuestQueryCall represents a call to the [answerGuestQuery] method.
// Use this method to reply to a received guest message. On success, a [SentGuestMessage] object is returned.
//
// [answerGuestQuery]: https://core.telegram.org/bots/api#answerguestquery
type AnswerGuestQueryCall struct {
	Call[SentGuestMessage]
}

// NewAnswerGuestQueryCall constructs a new [AnswerGuestQueryCall].
//
// Required params:
//   - guestQueryID: Unique identifier for the query to be answered
//   - result: A JSON-serialized object describing the message to be sent
func NewAnswerGuestQueryCall(guestQueryID string, result InlineQueryResultClass) *AnswerGuestQueryCall {
	return &AnswerGuestQueryCall{
		Call[SentGuestMessage]{
			request: NewRequest("answerGuestQuery").
				String("guest_query_id", guestQueryID).
				JSON("result", result.AsInlineQueryResult()),
		},
	}
}

// AnswerGuestQuery constructs a new [AnswerGuestQueryCall].
//
// Required params:
//   - guestQueryID: Unique identifier for the query to be answered
//   - result: A JSON-serialized object describing the message to be sent
func (client *Client) AnswerGuestQuery(guestQueryID string, result InlineQueryResultClass) *AnswerGuestQueryCall {
	return BindClient(
		NewAnswerGuestQueryCall(guestQueryID, result),
		client,
	)
}

// GuestQueryID sets the guest_query_id parameter.
func (call *AnswerGuestQueryCall) GuestQueryID(guestQueryID string) *AnswerGuestQueryCall {
	call.request.String("guest_query_id", guestQueryID)
	return call
}

// Result sets the result parameter.
func (call *AnswerGuestQueryCall) Result(result InlineQueryResultClass) *AnswerGuestQueryCall {
...
// NewGetManagedBotTokenCall constructs a new [GetManagedBotTokenCall].
//
// Required params:
...
// GetManagedBotToken constructs a new [GetManagedBotTokenCall].
//
// Required params:
//   - userID: User identifier of the managed bot whose token will be returned
...
// NewReplaceManagedBotTokenCall constructs a new [ReplaceManagedBotTokenCall].
//
// Required params:
...
// ReplaceManagedBotToken constructs a new [ReplaceManagedBotTokenCall].
//
// Required params:
//   - userID: User identifier of the managed bot whose token will be replaced
...
// GetManagedBotAccessSettingsCall represents a call to the [getManagedBotAccessSettings] method.
// Use this method to get the access settings of a managed bot. Returns a [BotAccessSettings] object on success.
//
// [getManagedBotAccessSettings]: https://core.telegram.org/bots/api#getmanagedbotaccesssettings
type GetManagedBotAccessSettingsCall struct {
	Call[BotAccessSettings]
}

// NewGetManagedBotAccessSettingsCall constructs a new [GetManagedBotAccessSettingsCall].
//
// Required params:
//   - userID: User identifier of the managed bot whose access settings will be returned
func NewGetManagedBotAccessSettingsCall(userID UserID) *GetManagedBotAccessSettingsCall {
	return &GetManagedBotAccessSettingsCall{
		Call[BotAccessSettings]{
			request: NewRequest("getManagedBotAccessSettings").
				UserID("user_id", userID),
		},
	}
}

// GetManagedBotAccessSettings constructs a new [GetManagedBotAccessSettingsCall].
//
// Required params:
//   - userID: User identifier of the managed bot whose access settings will be returned
func (client *Client) GetManagedBotAccessSettings(userID UserID) *GetManagedBotAccessSettingsCall {
	return BindClient(
		NewGetManagedBotAccessSettingsCall(userID),
		client,
	)
}

// UserID sets the user_id parameter.
func (call *GetManagedBotAccessSettingsCall) UserID(userID UserID) *GetManagedBotAccessSettingsCall {
	call.request.UserID("user_id", userID)
	return call
}

// SetManagedBotAccessSettingsCall represents a call to the [setManagedBotAccessSettings] method.
// Use this method to change the access settings of a managed bot. Returns True on success.
//
// [setManagedBotAccessSettings]: https://core.telegram.org/bots/api#setmanagedbotaccesssettings
type SetManagedBotAccessSettingsCall struct {
	CallNoResult
}

// NewSetManagedBotAccessSettingsCall constructs a new [SetManagedBotAccessSettingsCall].
//
// Required params:
...
func NewSetManagedBotAccessSettingsCall(userID UserID, isAccessRestricted bool) *SetManagedBotAccessSettingsCall {
	return &SetManagedBotAccessSettingsCall{
		CallNoResult{
			request: NewRequest("setManagedBotAccessSettings").
				UserID("user_id", userID).
				Bool("is_access_restricted", isAccessRestricted),
		},
	}
}

// SetManagedBotAccessSettings constructs a new [SetManagedBotAccessSettingsCall].
//
// Required params:
//   - userID: User identifier of the managed bot whose access settings will be changed
//   - isAccessRestricted: Pass True if only selected users can access the bot. The bot's owner can always access it.
func (client *Client) SetManagedBotAccessSettings(userID UserID, isAccessRestricted bool) *SetManagedBotAccessSettingsCall {
	return BindClient(
		NewSetManagedBotAccessSettingsCall(userID, isAccessRestricted),
		client,
	)
}

// UserID sets the user_id parameter.
func (call *SetManagedBotAccessSettingsCall) UserID(userID UserID) *SetManagedBotAccessSettingsCall {
	call.request.UserID("user_id", userID)
	return call
}

// IsAccessRestricted sets the is_access_restricted parameter.
func (call *SetManagedBotAccessSettingsCall) IsAccessRestricted(isAccessRestricted bool) *SetManagedBotAccessSettingsCall {
	call.request.Bool("is_access_restricted", isAccessRestricted)
	return call
}

// AddedUserIDs sets the added_user_ids parameter.
func (call *SetManagedBotAccessSettingsCall) AddedUserIDs(addedUserIDs []int) *SetManagedBotAccessSettingsCall {
	call.request.JSON("added_user_ids", addedUserIDs)
	return call
}
...
// SetMyProfilePhotoCall represents a call to the [setMyProfilePhoto] method.
...
func NewSetMyProfilePhotoCall(photo InputProfilePhotoClass) *SetMyProfilePhotoCall {
	return &SetMyProfilePhotoCall{
		CallNoResult{
			request: NewRequest("setMyProfilePhoto").
...
func (client *Client) SetMyProfilePhoto(photo InputProfilePhotoClass) *SetMyProfilePhotoCall {
	return BindClient(
		NewSetMyProfilePhotoCall(photo),
		client,
	)
}

// Photo sets the photo parameter.
func (call *SetMyProfilePhotoCall) Photo(photo InputProfilePhotoClass) *SetMyProfilePhotoCall {
	call.request.JSON("photo", photo.AsInputProfilePhoto())
	return call
}

// RemoveMyProfilePhotoCall represents a call to the [removeMyProfilePhoto] method.
...
func NewRemoveMyProfilePhotoCall() *RemoveMyProfilePhotoCall {
	return &RemoveMyProfilePhotoCall{
		CallNoResult{
			request: NewRequest("removeMyProfilePhoto"),
		},
	}
}
...
// SavePreparedKeyboardButtonCall represents a call to the [savePreparedKeyboardButton] method.
// Stores a keyboard button that can be used by a user within a Mini App. Returns a [PreparedKeyboardButton] object.
//
// [savePreparedKeyboardButton]: https://core.telegram.org/bots/api#savepreparedkeyboardbutton
type SavePreparedKeyboardButtonCall struct {
	Call[PreparedKeyboardButton]
}

// NewSavePreparedKeyboardButtonCall constructs a new [SavePreparedKeyboardButtonCall].
//
// Required params:
...
func NewSavePreparedKeyboardButtonCall(userID UserID, button KeyboardButton) *SavePreparedKeyboardButtonCall {
	return &SavePreparedKeyboardButtonCall{
		Call[PreparedKeyboardButton]{
			request: NewRequest("savePreparedKeyboardButton").
				UserID("user_id", userID).
				JSON("button", button),
		},
	}
...
// SavePreparedKeyboardButton constructs a new [SavePreparedKeyboardButtonCall].
//
// Required params:
//   - userID: Unique identifier of the target user that can use the button
//   - button: A JSON-serialized object describing the button to be saved. The button must be of the type request_users, request_chat, or request_managed_bot.
func (client *Client) SavePreparedKeyboardButton(userID UserID, button KeyboardButton) *SavePreparedKeyboardButtonCall {
	return BindClient(
		NewSavePreparedKeyboardButtonCall(userID, button),
		client,
	)
}

// UserID sets the user_id parameter.
func (call *SavePreparedKeyboardButtonCall) UserID(userID UserID) *SavePreparedKeyboardButtonCall {
	call.request.UserID("user_id", userID)
	return call
}

// Button sets the button parameter.
func (call *SavePreparedKeyboardButtonCall) Button(button KeyboardButton) *SavePreparedKeyboardButtonCall {
...
// RichMessage sets the rich_message parameter.
func (call *EditMessageTextCall) RichMessage(richMessage InputRichMessage) *EditMessageTextCall {
	call.request.JSON("rich_message", richMessage)
	return call
}
...
func NewEditMessageChecklistCall(businessConnectionID string, chatID PeerID, messageID int, checklist InputChecklist) *EditMessageChecklistCall {
...
//   - messageID: Unique identifier for the target message
//   - checklist: A JSON-serialized object for the new checklist
func (client *Client) EditMessageChecklist(businessConnectionID string, chatID PeerID, messageID int, checklist InputChecklist) *EditMessageChecklistCall {
	return BindClient(
...
// ChatID sets the chat_id parameter.
func (call *EditMessageChecklistCall) ChatID(chatID PeerID) *EditMessageChecklistCall {
	call.request.PeerID("chat_id", chatID)
	return call
}
...
// EditEphemeralMessageTextCall represents a call to the [editEphemeralMessageText] method.
...
type EditEphemeralMessageTextCall struct {
	CallNoResult
}

// NewEditEphemeralMessageTextCall constructs a new [EditEphemeralMessageTextCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
...
func NewEditEphemeralMessageTextCall(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageTextCall {
	return &EditEphemeralMessageTextCall{
		CallNoResult{
			request: NewRequest("editEphemeralMessageText").
				PeerID("chat_id", chatID).
				UserID("receiver_user_id", receiverUserID).
				Int("ephemeral_message_id", ephemeralMessageID),
		},
	}
}

// EditEphemeralMessageText constructs a new [EditEphemeralMessageTextCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
func (client *Client) EditEphemeralMessageText(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageTextCall {
	return BindClient(
		NewEditEphemeralMessageTextCall(chatID, receiverUserID, ephemeralMessageID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *EditEphemeralMessageTextCall) ChatID(chatID PeerID) *EditEphemeralMessageTextCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// ReceiverUserID sets the receiver_user_id parameter.
func (call *EditEphemeralMessageTextCall) ReceiverUserID(receiverUserID UserID) *EditEphemeralMessageTextCall {
	call.request.UserID("receiver_user_id", receiverUserID)
	return call
}

// EphemeralMessageID sets the ephemeral_message_id parameter.
func (call *EditEphemeralMessageTextCall) EphemeralMessageID(ephemeralMessageID int) *EditEphemeralMessageTextCall {
	call.request.Int("ephemeral_message_id", ephemeralMessageID)
	return call
}

// Text sets the text parameter.
func (call *EditEphemeralMessageTextCall) Text(text string) *EditEphemeralMessageTextCall {
	call.request.String("text", text)
	return call
}

// ParseMode sets the parse_mode parameter.
func (call *EditEphemeralMessageTextCall) ParseMode(parseMode ParseMode) *EditEphemeralMessageTextCall {
	call.request.Stringer("parse_mode", parseMode)
	return call
}

// Entities sets the entities parameter.
func (call *EditEphemeralMessageTextCall) Entities(entities []MessageEntity) *EditEphemeralMessageTextCall {
	call.request.JSON("entities", entities)
	return call
}

// RichMessage sets the rich_message parameter.
func (call *EditEphemeralMessageTextCall) RichMessage(richMessage InputRichMessage) *EditEphemeralMessageTextCall {
	call.request.JSON("rich_message", richMessage)
	return call
}

// LinkPreviewOptions sets the link_preview_options parameter.
func (call *EditEphemeralMessageTextCall) LinkPreviewOptions(linkPreviewOptions LinkPreviewOptions) *EditEphemeralMessageTextCall {
	call.request.JSON("link_preview_options", linkPreviewOptions)
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *EditEphemeralMessageTextCall) ReplyMarkup(replyMarkup InlineKeyboardMarkup) *EditEphemeralMessageTextCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}

// EditEphemeralMessageMediaCall represents a call to the [editEphemeralMessageMedia] method.
...
type EditEphemeralMessageMediaCall struct {
	CallNoResult
}

// NewEditEphemeralMessageMediaCall constructs a new [EditEphemeralMessageMediaCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
//   - media: A JSON-serialized object for the new media content of the message
func NewEditEphemeralMessageMediaCall(chatID PeerID, receiverUserID UserID, ephemeralMessageID int, media InputMediaClass) *EditEphemeralMessageMediaCall {
	return &EditEphemeralMessageMediaCall{
		CallNoResult{
			request: NewRequest("editEphemeralMessageMedia").
				PeerID("chat_id", chatID).
				UserID("receiver_user_id", receiverUserID).
				Int("ephemeral_message_id", ephemeralMessageID).
				InputMedia("media", media.AsInputMedia()),
...
// EditEphemeralMessageMedia constructs a new [EditEphemeralMessageMediaCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
//   - media: A JSON-serialized object for the new media content of the message
func (client *Client) EditEphemeralMessageMedia(chatID PeerID, receiverUserID UserID, ephemeralMessageID int, media InputMediaClass) *EditEphemeralMessageMediaCall {
	return BindClient(
		NewEditEphemeralMessageMediaCall(chatID, receiverUserID, ephemeralMessageID, media),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *EditEphemeralMessageMediaCall) ChatID(chatID PeerID) *EditEphemeralMessageMediaCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// ReceiverUserID sets the receiver_user_id parameter.
func (call *EditEphemeralMessageMediaCall) ReceiverUserID(receiverUserID UserID) *EditEphemeralMessageMediaCall {
	call.request.UserID("receiver_user_id", receiverUserID)
	return call
}

// EphemeralMessageID sets the ephemeral_message_id parameter.
func (call *EditEphemeralMessageMediaCall) EphemeralMessageID(ephemeralMessageID int) *EditEphemeralMessageMediaCall {
	call.request.Int("ephemeral_message_id", ephemeralMessageID)
	return call
}

// Media sets the media parameter.
func (call *EditEphemeralMessageMediaCall) Media(media InputMediaClass) *EditEphemeralMessageMediaCall {
	call.request.InputMedia("media", media.AsInputMedia())
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *EditEphemeralMessageMediaCall) ReplyMarkup(replyMarkup InlineKeyboardMarkup) *EditEphemeralMessageMediaCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}

// EditEphemeralMessageCaptionCall represents a call to the [editEphemeralMessageCaption] method.
...
type EditEphemeralMessageCaptionCall struct {
	CallNoResult
}

// NewEditEphemeralMessageCaptionCall constructs a new [EditEphemeralMessageCaptionCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
func NewEditEphemeralMessageCaptionCall(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageCaptionCall {
	return &EditEphemeralMessageCaptionCall{
		CallNoResult{
			request: NewRequest("editEphemeralMessageCaption").
				PeerID("chat_id", chatID).
				UserID("receiver_user_id", receiverUserID).
				Int("ephemeral_message_id", ephemeralMessageID),
		},
...
// EditEphemeralMessageCaption constructs a new [EditEphemeralMessageCaptionCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
func (client *Client) EditEphemeralMessageCaption(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageCaptionCall {
	return BindClient(
		NewEditEphemeralMessageCaptionCall(chatID, receiverUserID, ephemeralMessageID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *EditEphemeralMessageCaptionCall) ChatID(chatID PeerID) *EditEphemeralMessageCaptionCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// ReceiverUserID sets the receiver_user_id parameter.
func (call *EditEphemeralMessageCaptionCall) ReceiverUserID(receiverUserID UserID) *EditEphemeralMessageCaptionCall {
	call.request.UserID("receiver_user_id", receiverUserID)
	return call
}

// EphemeralMessageID sets the ephemeral_message_id parameter.
func (call *EditEphemeralMessageCaptionCall) EphemeralMessageID(ephemeralMessageID int) *EditEphemeralMessageCaptionCall {
	call.request.Int("ephemeral_message_id", ephemeralMessageID)
	return call
}

// Caption sets the caption parameter.
func (call *EditEphemeralMessageCaptionCall) Caption(caption string) *EditEphemeralMessageCaptionCall {
	call.request.String("caption", caption)
	return call
}

// ParseMode sets the parse_mode parameter.
func (call *EditEphemeralMessageCaptionCall) ParseMode(parseMode ParseMode) *EditEphemeralMessageCaptionCall {
	call.request.Stringer("parse_mode", parseMode)
	return call
}

// CaptionEntities sets the caption_entities parameter.
func (call *EditEphemeralMessageCaptionCall) CaptionEntities(captionEntities []MessageEntity) *EditEphemeralMessageCaptionCall {
	call.request.JSON("caption_entities", captionEntities)
	return call
}

// ShowCaptionAboveMedia sets the show_caption_above_media parameter.
func (call *EditEphemeralMessageCaptionCall) ShowCaptionAboveMedia(showCaptionAboveMedia bool) *EditEphemeralMessageCaptionCall {
	call.request.Bool("show_caption_above_media", showCaptionAboveMedia)
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *EditEphemeralMessageCaptionCall) ReplyMarkup(replyMarkup InlineKeyboardMarkup) *EditEphemeralMessageCaptionCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}

// EditEphemeralMessageReplyMarkupCall represents a call to the [editEphemeralMessageReplyMarkup] method.
...
type EditEphemeralMessageReplyMarkupCall struct {
	CallNoResult
}

// NewEditEphemeralMessageReplyMarkupCall constructs a new [EditEphemeralMessageReplyMarkupCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
func NewEditEphemeralMessageReplyMarkupCall(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageReplyMarkupCall {
	return &EditEphemeralMessageReplyMarkupCall{
		CallNoResult{
			request: NewRequest("editEphemeralMessageReplyMarkup").
				PeerID("chat_id", chatID).
				UserID("receiver_user_id", receiverUserID).
				Int("ephemeral_message_id", ephemeralMessageID),
		},
...
// EditEphemeralMessageReplyMarkup constructs a new [EditEphemeralMessageReplyMarkupCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to edit
func (client *Client) EditEphemeralMessageReplyMarkup(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *EditEphemeralMessageReplyMarkupCall {
	return BindClient(
		NewEditEphemeralMessageReplyMarkupCall(chatID, receiverUserID, ephemeralMessageID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *EditEphemeralMessageReplyMarkupCall) ChatID(chatID PeerID) *EditEphemeralMessageReplyMarkupCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// ReceiverUserID sets the receiver_user_id parameter.
func (call *EditEphemeralMessageReplyMarkupCall) ReceiverUserID(receiverUserID UserID) *EditEphemeralMessageReplyMarkupCall {
	call.request.UserID("receiver_user_id", receiverUserID)
	return call
}

// EphemeralMessageID sets the ephemeral_message_id parameter.
func (call *EditEphemeralMessageReplyMarkupCall) EphemeralMessageID(ephemeralMessageID int) *EditEphemeralMessageReplyMarkupCall {
	call.request.Int("ephemeral_message_id", ephemeralMessageID)
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *EditEphemeralMessageReplyMarkupCall) ReplyMarkup(replyMarkup InlineKeyboardMarkup) *EditEphemeralMessageReplyMarkupCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}
...
// DeleteEphemeralMessageCall represents a call to the [deleteEphemeralMessage] method.
// Use this method to delete an ephemeral message. Note that it is not guaranteed that the user will receive the message deletion event, especially if they are offline. Returns True on success.
//
// [deleteEphemeralMessage]: https://core.telegram.org/bots/api#deleteephemeralmessage
type DeleteEphemeralMessageCall struct {
	CallNoResult
}

// NewDeleteEphemeralMessageCall constructs a new [DeleteEphemeralMessageCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to delete
func NewDeleteEphemeralMessageCall(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *DeleteEphemeralMessageCall {
	return &DeleteEphemeralMessageCall{
		CallNoResult{
			request: NewRequest("deleteEphemeralMessage").
				PeerID("chat_id", chatID).
				UserID("receiver_user_id", receiverUserID).
				Int("ephemeral_message_id", ephemeralMessageID),
		},
...
// DeleteEphemeralMessage constructs a new [DeleteEphemeralMessageCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - receiverUserID: Identifier of the user who received the message
//   - ephemeralMessageID: Identifier of the ephemeral message to delete
func (client *Client) DeleteEphemeralMessage(chatID PeerID, receiverUserID UserID, ephemeralMessageID int) *DeleteEphemeralMessageCall {
	return BindClient(
		NewDeleteEphemeralMessageCall(chatID, receiverUserID, ephemeralMessageID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *DeleteEphemeralMessageCall) ChatID(chatID PeerID) *DeleteEphemeralMessageCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// ReceiverUserID sets the receiver_user_id parameter.
func (call *DeleteEphemeralMessageCall) ReceiverUserID(receiverUserID UserID) *DeleteEphemeralMessageCall {
	call.request.UserID("receiver_user_id", receiverUserID)
	return call
}

// EphemeralMessageID sets the ephemeral_message_id parameter.
func (call *DeleteEphemeralMessageCall) EphemeralMessageID(ephemeralMessageID int) *DeleteEphemeralMessageCall {
	call.request.Int("ephemeral_message_id", ephemeralMessageID)
	return call
}

// DeleteMessageReactionCall represents a call to the [deleteMessageReaction] method.
// Use this method to remove a reaction from a message in a group or a supergroup chat. The bot must have the 'can_delete_messages' administrator right in the chat. Returns True on success.
//
// [deleteMessageReaction]: https://core.telegram.org/bots/api#deletemessagereaction
type DeleteMessageReactionCall struct {
	CallNoResult
}

// NewDeleteMessageReactionCall constructs a new [DeleteMessageReactionCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - messageID: Identifier of the target message
func NewDeleteMessageReactionCall(chatID PeerID, messageID int) *DeleteMessageReactionCall {
	return &DeleteMessageReactionCall{
		CallNoResult{
			request: NewRequest("deleteMessageReaction").
				PeerID("chat_id", chatID).
				Int("message_id", messageID),
		},
	}
...
// DeleteMessageReaction constructs a new [DeleteMessageReactionCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
//   - messageID: Identifier of the target message
func (client *Client) DeleteMessageReaction(chatID PeerID, messageID int) *DeleteMessageReactionCall {
	return BindClient(
		NewDeleteMessageReactionCall(chatID, messageID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *DeleteMessageReactionCall) ChatID(chatID PeerID) *DeleteMessageReactionCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// MessageID sets the message_id parameter.
func (call *DeleteMessageReactionCall) MessageID(messageID int) *DeleteMessageReactionCall {
	call.request.Int("message_id", messageID)
	return call
}

// UserID sets the user_id parameter.
func (call *DeleteMessageReactionCall) UserID(userID UserID) *DeleteMessageReactionCall {
	call.request.UserID("user_id", userID)
	return call
}

// ActorChatID sets the actor_chat_id parameter.
func (call *DeleteMessageReactionCall) ActorChatID(actorChatID int) *DeleteMessageReactionCall {
	call.request.Int("actor_chat_id", actorChatID)
	return call
}

// DeleteAllMessageReactionsCall represents a call to the [deleteAllMessageReactions] method.
...
type DeleteAllMessageReactionsCall struct {
	CallNoResult
}

// NewDeleteAllMessageReactionsCall constructs a new [DeleteAllMessageReactionsCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
func NewDeleteAllMessageReactionsCall(chatID PeerID) *DeleteAllMessageReactionsCall {
	return &DeleteAllMessageReactionsCall{
		CallNoResult{
			request: NewRequest("deleteAllMessageReactions").
				PeerID("chat_id", chatID),
		},
	}
}

// DeleteAllMessageReactions constructs a new [DeleteAllMessageReactionsCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target supergroup in the format @username
func (client *Client) DeleteAllMessageReactions(chatID PeerID) *DeleteAllMessageReactionsCall {
	return BindClient(
		NewDeleteAllMessageReactionsCall(chatID),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *DeleteAllMessageReactionsCall) ChatID(chatID PeerID) *DeleteAllMessageReactionsCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// UserID sets the user_id parameter.
func (call *DeleteAllMessageReactionsCall) UserID(userID UserID) *DeleteAllMessageReactionsCall {
	call.request.UserID("user_id", userID)
	return call
}

// ActorChatID sets the actor_chat_id parameter.
func (call *DeleteAllMessageReactionsCall) ActorChatID(actorChatID int) *DeleteAllMessageReactionsCall {
	call.request.Int("actor_chat_id", actorChatID)
	return call
}
...
// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendStickerCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendStickerCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}
...
// SendRichMessageCall represents a call to the [sendRichMessage] method.
// Use this method to send rich messages. If the message contains a block with a media element, then the bot must have the right to send the media to the chat. On success, the sent [Message] is returned.
//
// [sendRichMessage]: https://core.telegram.org/bots/api#sendrichmessage
type SendRichMessageCall struct {
	Call[Message]
}

// NewSendRichMessageCall constructs a new [SendRichMessageCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username
//   - richMessage: The message to be sent
func NewSendRichMessageCall(chatID PeerID, richMessage InputRichMessage) *SendRichMessageCall {
	return &SendRichMessageCall{
		Call[Message]{
			request: NewRequest("sendRichMessage").
				PeerID("chat_id", chatID).
				JSON("rich_message", richMessage),
		},
	}
}

// SendRichMessage constructs a new [SendRichMessageCall].
//
// Required params:
//   - chatID: Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username
//   - richMessage: The message to be sent
func (client *Client) SendRichMessage(chatID PeerID, richMessage InputRichMessage) *SendRichMessageCall {
	return BindClient(
		NewSendRichMessageCall(chatID, richMessage),
		client,
	)
}

// BusinessConnectionID sets the business_connection_id parameter.
func (call *SendRichMessageCall) BusinessConnectionID(businessConnectionID string) *SendRichMessageCall {
	call.request.String("business_connection_id", businessConnectionID)
	return call
}

// ChatID sets the chat_id parameter.
func (call *SendRichMessageCall) ChatID(chatID PeerID) *SendRichMessageCall {
	call.request.PeerID("chat_id", chatID)
	return call
}

// MessageThreadID sets the message_thread_id parameter.
func (call *SendRichMessageCall) MessageThreadID(messageThreadID int) *SendRichMessageCall {
	call.request.Int("message_thread_id", messageThreadID)
	return call
}

// DirectMessagesTopicID sets the direct_messages_topic_id parameter.
func (call *SendRichMessageCall) DirectMessagesTopicID(directMessagesTopicID int) *SendRichMessageCall {
	call.request.Int("direct_messages_topic_id", directMessagesTopicID)
	return call
}

// EphemeralMessageParameters sets the ephemeral_message_parameters parameter.
func (call *SendRichMessageCall) EphemeralMessageParameters(ephemeralMessageParameters EphemeralMessageParameters) *SendRichMessageCall {
	call.request.JSON("ephemeral_message_parameters", ephemeralMessageParameters)
	return call
}

// RichMessage sets the rich_message parameter.
func (call *SendRichMessageCall) RichMessage(richMessage InputRichMessage) *SendRichMessageCall {
	call.request.JSON("rich_message", richMessage)
	return call
}

// DisableNotification sets the disable_notification parameter.
func (call *SendRichMessageCall) DisableNotification(disableNotification bool) *SendRichMessageCall {
	call.request.Bool("disable_notification", disableNotification)
	return call
}

// ProtectContent sets the protect_content parameter.
func (call *SendRichMessageCall) ProtectContent(protectContent bool) *SendRichMessageCall {
	call.request.Bool("protect_content", protectContent)
	return call
}

// AllowPaidBroadcast sets the allow_paid_broadcast parameter.
func (call *SendRichMessageCall) AllowPaidBroadcast(allowPaidBroadcast bool) *SendRichMessageCall {
	call.request.Bool("allow_paid_broadcast", allowPaidBroadcast)
	return call
}

// MessageEffectID sets the message_effect_id parameter.
func (call *SendRichMessageCall) MessageEffectID(messageEffectID string) *SendRichMessageCall {
	call.request.String("message_effect_id", messageEffectID)
	return call
}

// SuggestedPostParameters sets the suggested_post_parameters parameter.
func (call *SendRichMessageCall) SuggestedPostParameters(suggestedPostParameters SuggestedPostParameters) *SendRichMessageCall {
	call.request.JSON("suggested_post_parameters", suggestedPostParameters)
	return call
}

// ReplyParameters sets the reply_parameters parameter.
func (call *SendRichMessageCall) ReplyParameters(replyParameters ReplyParameters) *SendRichMessageCall {
	call.request.JSON("reply_parameters", replyParameters)
	return call
}

// ReplyMarkup sets the reply_markup parameter.
func (call *SendRichMessageCall) ReplyMarkup(replyMarkup ReplyMarkup) *SendRichMessageCall {
	call.request.JSON("reply_markup", replyMarkup)
	return call
}

// SendRichMessageDraftCall represents a call to the [sendRichMessageDraft] method.
// Use this method to stream a partial rich message to a user while the message is being generated. Note that the streamed draft is ephemeral and acts as a temporary 30-second preview - once the output is finalized, you must call [Client.SendRichMessage] with the complete message to persist it in the user's chat. Returns True on success.
//
// [sendRichMessageDraft]: https://core.telegram.org/bots/api#sendrichmessagedraft
type SendRichMessageDraftCall struct {
	CallNoResult
}

// NewSendRichMessageDraftCall constructs a new [SendRichMessageDraftCall].
//
// Required params:
//   - chatID: Unique identifier for the target private chat
//   - draftID: Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. Otherwise, the draft is replaced without animation.
...
func NewSendRichMessageDraftCall(chatID int, draftID int, richMessage InputRichMessage) *SendRichMessageDraftCall {
	return &SendRichMessageDraftCall{
		CallNoResult{
			request: NewRequest("sendRichMessageDraft").
				Int("chat_id", chatID).
				Int("draft_id", draftID).
				JSON("rich_message", richMessage),
		},
...
// SendRichMessageDraft constructs a new [SendRichMessageDraftCall].
//
// Required params:
//   - chatID: Unique identifier for the target private chat
//   - draftID: Unique identifier of the message draft; must be non-zero. Changes to drafts with the same identifier are animated. Otherwise, the draft is replaced without animation.
//   - richMessage: The partial message to be streamed. Direct upload of new files and explicit upload of files by a URL isn't supported.
func (client *Client) SendRichMessageDraft(chatID int, draftID int, richMessage InputRichMessage) *SendRichMessageDraftCall {
	return BindClient(
		NewSendRichMessageDraftCall(chatID, draftID, richMessage),
		client,
	)
}

// ChatID sets the chat_id parameter.
func (call *SendRichMessageDraftCall) ChatID(chatID int) *SendRichMessageDraftCall {
	call.request.Int("chat_id", chatID)
	return call
}

// MessageThreadID sets the message_thread_id parameter.
func (call *SendRichMessageDraftCall) MessageThreadID(messageThreadID int) *SendRichMessageDraftCall {
	call.request.Int("message_thread_id", messageThreadID)
	return call
}

// DraftID sets the draft_id parameter.
func (call *SendRichMessageDraftCall) DraftID(draftID int) *SendRichMessageDraftCall {
	call.request.Int("draft_id", draftID)
	return call
}

// RichMessage sets the rich_message parameter.
func (call *SendRichMessageDraftCall) RichMessage(richMessage InputRichMessage) *SendRichMessageDraftCall {
	call.request.JSON("rich_message", richMessage)
	return call
}

// CanStop sets the can_stop parameter.
func (call *SendRichMessageDraftCall) CanStop(canStop bool) *SendRichMessageDraftCall {
	call.request.Bool("can_stop", canStop)
	return call
}

// KeepOnStop sets the keep_on_stop parameter.
func (call *SendRichMessageDraftCall) KeepOnStop(keepOnStop bool) *SendRichMessageDraftCall {
	call.request.Bool("keep_on_stop", keepOnStop)
	return call
}
...
//
// [@BotFather]: https://t.me/botfather
func NewSendGameCall(chatID PeerID, gameShortName string) *SendGameCall {
	return &SendGameCall{
		Call[Message]{
...
//
// [@BotFather]: https://t.me/botfather
func (client *Client) SendGame(chatID PeerID, gameShortName string) *SendGameCall {
	return BindClient(
...
// ChatID sets the chat_id parameter.
func (call *SendGameCall) ChatID(chatID PeerID) *SendGameCall {
	call.request.PeerID("chat_id", chatID)
	return call
}
